...
void CEDROOMSystemCommSAP::RegisterInterfaces(){
	...
	m_localCommSAP.RegisterInterface(3, mp_comp6->GuidancePeriod, mp_comp6);
...
void CEDROOMSystemCommSAP::SetLocalConnections(){
	...
	m_localCommSAP.Connect(mp_comp3->TMChannelCtrl4, mp_comp6->TMChannelCtrl, connections[1], 
